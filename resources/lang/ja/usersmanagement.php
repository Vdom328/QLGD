...
return [
    ...
    // Titles
    'showing-all-users'     => 'すべてのユーザーを表示中',
    'users-menu-alt'        => 'Show Users Management Menu',
    'create-new-user'       => 'ユーザーの作成',
    'show-deleted-users'    => 'Show Deleted User',
    'editing-user'          => 'ユーザー編集 :name',
    ...
    'buttons' => [
        'create-new'    => 'New User',
        'delete'        => '<i class="fa fa-trash fa-fw" aria-hidden="true"></i>  <span class="hidden-xs hidden-sm">Delete</span><span class="hidden-xs hidden-sm hidden-md"> </span>',
        ...
        'back-to-users' => '<span class="hidden-sm hidden-xs">ユーザーに戻る</span>',
