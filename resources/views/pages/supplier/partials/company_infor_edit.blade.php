<form
method="post" action="{{ route('supplier.saveEdit',$supplier->id) }}"
class="row d-flex pt-3 pb-3 flex-wrap bg-white rounded shadow-sm"
    ...
    <div class="row col-xl-11 col-12  flex-wrap align-items-center">
        <div class="col-xl-5 col-12 ">
            <div class="row col-12 d-flex flex-wrap align-items-center">
                ...
                <div class="col-5">
                    <input type="text" class="form-control code" name="" value="{{ old('code',$supplier->code ?? '') }}" disabled>
                    <input type="hidden" name="code" value="{{ old('code',$supplier->code ?? '') }}">
                </div>
            ...
            <div class="row col-12 d-flex align-items-center">
                ...
                <div class="col-xl-8 col-12 d-flex p-xl-0">
                    <input type="text" class="form-control" name="invoice_number"
                        value="{{ old('invoice_number',$supplier->invoice_number ?? '') }}">
                </div>
            </div>
            <div class="row d-flex flex-wrap align-items-center ">
        ...
        <div class="col-12 pe-0">
            <div class="row col-12 d-flex flex-wrap align-items-center p-0">
                ...
                <div class="col-xl-10 col-12 pe-0"><input type="text" class="form-control" name="name"
                        value="{{ old('name',$supplier->name ?? '') }}"></div>
            </div>
            <div class="row d-flex flex-wrap align-items-center ">
        ...
        <div class="col-xl-5 col-12 ">
            <div class="row col-12 d-flex flex-wrap align-items-center">
                ...
                <div class="col-3"><input type="text" class="form-control" name="postcode-first" id="postcode-first"
                        value="{{ old('postcode-first',  $supplier->postcode_first) }}"></div>
                <div class="col-1 text-center">~</div>
                <div class="col-3"><input type="text" class="form-control" name="postcode-last" id="postcode-last"
                        value="{{ old('postcode-last',  $supplier->postcode_last) }}"></div>
            </div>
            <div class="row col-12 d-flex flex-wrap align-items-center">
                <div class="col-xl-5 col-12 text-xl-end">  </div>
                ...
                <div class="col-xl-8 col-12 d-flex p-xl-0">
                    <select name="prefecture_id" class="form-select">
                        ...
                        @foreach ($provinces as $province)
                            <option value="{{ $province->id }}" @if ($supplier->prefecture_id == $province->id) selected @endif
        ...
        <div class="col-12 pe-0">
            <div class="row col-12 d-flex flex-wrap align-items-center p-0">
                ...
                <div class="col-xl-10 col-12 pe-0"><input type="text" class="form-control" name="address"
                        value="{{ old('address',$supplier->address ?? '') }}"></div>
            </div>
            <div class="row d-flex flex-wrap align-items-center ">
                <div class="col-xl-2 col-12 text-xl-end"></div>
                <div class="row col-xl-10 col-12 d-flex align-items-center">
        ...
        <div class="col-12 pe-0">
            <div class="row col-12 d-flex flex-wrap align-items-center p-0">
                ...
                <div class="col-xl-10 col-12 pe-0"><input type="text" class="form-control" name="building_name"
                        value="{{ old('building_name',$supplier->building_name ?? '') }}"></div>
            </div>
            <div class="row d-flex flex-wrap align-items-center ">
                <div class="col-xl-2 col-12 text-xl-end"></div>
                <div class="row col-xl-10 col-12 d-flex align-items-center">
        ...
        <div class=" col-xl-7 col-12 p-xl-0">
            <div class="row col-12 d-flex align-items-center">
                ...
                <div class="col-xl-8 col-12 d-flex p-xl-0"> <input type="text" class="form-control number"
                        name="fax" value="{{ old('fax',$supplier->fax ?? '') }}"></div>
            </div>
            <div class="row d-flex flex-wrap align-items-center ">
                <div class="col-xl-4 col-12 text-xl-end"></div>
                <div class="row col-xl-8 col-12 p-xl-0 d-flex align-items-center">
        ...
        <div class="col-xl-5 col-12 ">
            <div class="row col-12 d-flex flex-wrap align-items-center">
                ...
                <div class="col-xl-7 col-12"><input type="text" class="form-control" name="email"
                        value="{{ old('email',$supplier->email ?? '') }}" ></div>
            </div>
            <div class="row col-12 d-flex flex-wrap align-items-center">
                <div class="col-xl-5 col-12 text-xl-end">  </div>
                ...
                <div class="col-xl-7 col-12 d-flex  align-items-center">
                    <select id="" class="form-select" name="payment_terms" >
                        ...
                        @foreach ( $paymentTerms as $paymentTerm)
                            <option value="{{ $paymentTerm->id }}" @if ($supplier->payment_terms == $paymentTerm->id) selected @endif {{ old('payment_terms') == $paymentTerm->id ? 'selected' : '' }}>{{ $paymentTerm->name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
        ...
        <div class="col-xl-5 col-12 ">
            <div class="row col-12 d-flex flex-wrap align-items-center">
                ...
                <div class="col-xl-7 col-12"> <input type="text" class="form-control" name="credit_limit"
                        value="{{ old('credit_limit',$supplier->credit_limit ?? '') }}"></div>
            </div>
            <div class="row d-flex flex-wrap align-items-center ">
                <div class="col-xl-5 col-12 text-xl-end"></div>
                <div class="row col-xl-8 col-12 d-flex align-items-center">
        ...
        <div class="col-12 pe-0">
            <div class="row col-12 d-flex flex-wrap  p-0">
                ...
                <div class="col-xl-10 col-12 pe-0">
                    <textarea name="memo" id="" rows="3" class="form-control">{{ old('memo',$supplier->memo ?? '') }}</textarea>
                </div>
            </div>
            <div class="row d-flex flex-wrap align-items-center ">
                <div class="col-xl-2 col-12 text-xl-end"></div>
            ...
            <div class="customer_table_container">
                <table class="col-12 customer_table">
                    ...
                    <tbody id="body_table_manager">
                        @for ($i = 0; $i < count($supplier->supplier_managers); $i++)
                            @php
                                $supplier_managers = $supplier->supplier_managers[$i];
                            @endphp
                            <tr class="form_manager" id="managers[{{ $i }}]">
                                <th style="min-width: 100px" class="text-end pe-4">担当者</th>
                                <td class="p-0">
                                    <input name="managers[{{ $i }}][id]" type="hidden" value="{{ $supplier_managers->id }}">
                                    <input name="managers[{{ $i }}][name_managers]" type="text" value="{{ $supplier_managers->name }}">
                                </td>
                                <td class="p-0">
                                    <input name="managers[{{ $i }}][email_managers]" type="text" value="{{ $supplier_managers->email }}">
                                </td>
                                <td class="p-0">
                                    <input name="managers[{{ $i }}][phone_managers]" type="tel" value="{{ $supplier_managers->phone }}" class="number">
                                </td>
                                <td class="p-0">
                                    <select name="managers[{{ $i }}][person_in_charge_id]" class="form-select border-0 select_staff">
                                        @foreach ($staffs as $staff)
                                            <option value="{{ $staff->id }}" @if ($supplier_managers->person_in_charge_id == $staff->id) selected @endif @if ($staff->profile->avatar)data-image="{{ asset('storage/avatarUser/' . $staff->profile->avatar) }}" @else data-image="{{ Avatar::create(Auth::user()->name)->toBase64() }}" @endif >
                                ...
                                <th class="d-flex align-items-center justify-content-end pt-2">
                                    @if ( count($supplier->supplier_managers) > 1)
    ...
    <div class="col-12 d-flex flex-wrap mt-5">
        <div class="col-xl-2 col-12 ps-md-5">
            ...
            dataTitle="{{trans('サプライヤーの削除')}}" dataMessage="{{trans('このサプライヤーを削除しますか?')}}"/>
        </div>
