...
@section('page_title_actions')
    <div class="col-12 d-flex flex-wrap align-items-center">
        <div class="col-md-6 col-12 ">
            <i class="fas fa-angle-right"></i> Sinh viên chỉ định
        </div>
    </div>
@endsection
        ...
        <div class="mt-3">
            ...
            <div class="row p-3 bg-white rounded-3 customer_table_container shadow-sm">
                <table class="table table-hover ">
                    <thead>
                        <tr>
                            <th  data-column="staff_no" data-direction="desc" class="sort_table">Mã sinh viên
                                <i class="ms-1 fas fa-sort icon_sort"></i>
                            </th>
                            <th></th>
                            <th data-column="name" data-direction="desc" class="sort_table">Tên sinh viên
                                <i class="ms-1 fas fa-sort icon_sort"></i>
                            </th>
                    ...
                    <tbody id="list_data">
                        @include('pages.student.partials._list')
                    </tbody>
                </table>
            </div>
            <div id="paginate">
