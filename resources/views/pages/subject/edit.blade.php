...
@section('page_title_actions')
    <div><i class="fas fa-angle-right"></i> Cài đặt môn học <i class="fas fa-angle-right"></i> Chỉnh sửa</div>
@endsection

@section('content')
    <form method="post" action="{{ route('subject.saveUpdate') }}"
                    ...
                    <div class="col-md-12 col-12 flex-wrap d-flex align-items-center">
                        <div class="col-md-8 col-12">
                            <input type="text" class="form-control" id="credits_no" placeholder="" name="credits_no"
                                value="{{ old('credits_no', $data->credits_no) }}">
                        </div>
        ...
        <div class="col-md-12 col-12 d-flex flex-wrap">
            <div class="col-md-6 col-12">
                ...
                <div class="d-flex flex-wrap align-items-center mb-2">
                    ...
                    <div class="col-md-12 col-12 d-flex align-items-center">
                        <div class="col-md-8 col-12">
                            <input type="number" class="form-control" id="quantity_credits" placeholder="" max="4" name="quantity_credits"
                                value="{{ old('quantity_credits',$data->quantity_credits) }}">
                        </div>
                    </div>
                </div>
                <div class=" d-flex flex-wrap align-items-center ">
            ...
            <div class="col-md-6 col-12">
                ...
                <div class="d-flex align-items-center">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" @if ($data->require_class_room == Config::get('const.status.yes')) checked @endif type="radio" name="require_class_room" id="require_class_room1" value="{{ Config::get('const.status.yes') }}">
                        <label class="form-check-label" for="require_class_room1">Đúng</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" @if ($data->require_class_room == Config::get('const.status.no')) checked @endif type="radio" name="require_class_room" id="require_class_room2" value="{{ Config::get('const.status.no') }}">
